...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "boost-1.89.0"
  WORKING_DIRECTORY "/home/ricky/coding/proyects/vulkancpp/build/_deps/boost_math-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ricky/coding/proyects/vulkancpp/build/_deps/boost_math-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ricky/coding/proyects/vulkancpp/build/_deps/boost_math-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
