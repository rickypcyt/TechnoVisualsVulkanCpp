...
const std::unordered_map<std::string, ParamBinding>& ParameterBindingRegistry::get() {
    static const std::unordered_map<std::string, ParamBinding> map = {
        ...
        { "playback.videoAspectRatio", {ParamBinding::Type::Int, nullptr, [](VisualControls& c) -> int& { return c.playback.videoAspectRatio; }} },
        { "playback.video2AspectRatio", {ParamBinding::Type::Int, nullptr, [](VisualControls& c) -> int& { return c.playback.video2AspectRatio; }} },
        { "playback.video3AspectRatio", {ParamBinding::Type::Int, nullptr, [](VisualControls& c) -> int& { return c.playback.video3AspectRatio; }} },
